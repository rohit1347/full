 ...
 */
#ifndef FULL_NQOS_WIFI_MAC_HELPER_H
#define FULL_NQOS_WIFI_MAC_HELPER_H
 ...
 */
class FullNqosWifiMacHelper : public FullWifiMacHelper
{
public:
  /**
  ...
  virtual ~FullNqosWifiMacHelper ();
  /**
   * Create a mac helper in a default working state.
   * i.e., this is an adhoc mac by default.
   */
  static FullNqosWifiMacHelper Default (void);
  /**
...
#endif /* FULL_NQOS_WIFI_MAC_HELPER_H */
