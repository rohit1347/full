 ...
 */
#ifndef FULL_QOS_WIFI_MAC_HELPER_H
#define FULL_QOS_WIFI_MAC_HELPER_H
 ...
 */
class FullQosWifiMacHelper : public FullWifiMacHelper
{
public:
  /**
   ...
   */
  virtual ~FullQosWifiMacHelper ();

  /**
   * Create a mac helper in a default working state.
   */
  static FullQosWifiMacHelper Default (void);
...
private:
   ...
   */
  virtual Ptr<FullWifiMac> Create (void) const;
  void Setup (Ptr<FullWifiMac> mac, enum AcIndex ac, std::string dcaAttrName) const;
...
#endif /* FULL_QOS_WIFI_MAC_HELPER_H */
