 ...
 */
#ifndef FULL_WIFI_HELPER_H
#define FULL_WIFI_HELPER_H
 ...
 */
class FullWifiPhyHelper
{
public:
  virtual ~FullWifiPhyHelper ();
   ...
   */
  virtual Ptr<FullWifiPhy> Create (Ptr<Node> node, Ptr<FullWifiNetDevice> device) const = 0;
};
 ...
 * with the \ref ns3::WifiHelper class.
 */
class FullWifiMacHelper
{
public:
  virtual ~FullWifiMacHelper ();
  /**
   ...
   */
  virtual Ptr<FullWifiMac> Create (void) const = 0;
};
...
public:
   ...
   * for 802.11a.
   */
  static FullWifiHelper Default (void);
   ...
   */
  NetDeviceContainer Install (const FullWifiPhyHelper &phy,
                              const FullWifiMacHelper &mac, NodeContainer c) const;
  /**
   * \param phy the PHY helper to create PHY objects
   * \param mac the MAC helper to create MAC objects
   ...
   */
  void SetStandard (enum FullWifiPhyStandard standard);
...
private:
  ...
  enum FullWifiPhyStandard m_standard;
};

} // namespace ns3

#endif /* FULL_WIFI_HELPER_H */
