 ...
 */
#ifndef FULL_NIST_ERROR_RATE_MODEL_H
#define FULL_NIST_ERROR_RATE_MODEL_H
 ...
 */
class FullNistErrorRateModel : public FullErrorRateModel
{
public:
  static TypeId GetTypeId (void);

  FullNistErrorRateModel ();

  virtual double GetChunkSuccessRate (FullWifiMode mode, double snr, uint32_t nbits) const;
...
#endif /* FULL_NIST_ERROR_RATE_MODEL_H */
