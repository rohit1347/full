...
#ifndef FULL_WIFI_INFORMATION_ELEMENT_VECTOR_H
#define FULL_WIFI_INFORMATION_ELEMENT_VECTOR_H
 ...
 */
class FullWifiInformationElementVector : public Header
{
public:
  FullWifiInformationElementVector ();
  ~FullWifiInformationElementVector ();
  ...
  typedef std::vector<Ptr<FullWifiInformationElement> >::iterator Iterator;
  /// Returns Begin of the vector
  Iterator Begin ();
  /// Returns End of the vector
  Iterator End ();
  /// add an IE, if maxSize has exceeded, returns false
  bool AddInformationElement (Ptr<FullWifiInformationElement> element);
  /// vector of pointers to information elements is the body of IeVector
  Ptr<FullWifiInformationElement> FindFirst (FullWifiInformationElementId id) const;

  virtual bool operator== (const FullWifiInformationElementVector & a) const;
protected:
  typedef std::vector<Ptr<FullWifiInformationElement> > IE_VECTOR;
...
#endif /* FULL_WIFI_INFORMATION_ELEMENT_VECTOR_H */
