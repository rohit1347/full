 ...
 */
#ifndef FULL_RANDOM_STREAM_H
#define FULL_RANDOM_STREAM_H
...
class FullRealRandomStream : public FullRandomStream
{
public:
  FullRealRandomStream ();
...
class FullTestRandomStream : public FullRandomStream
{
public:
