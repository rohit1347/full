 ...
 */
#ifndef FULL_WIFI_MAC_H
#define FULL_WIFI_MAC_H
 ...
 *
 */
class FullWifiMac : public Object
{
public:
   ...
   */
  virtual FullSsid GetSsid (void) const = 0;
  /**
   ...
   */
  virtual void SetSsid (FullSsid ssid) = 0;
  /**
   ...
   */
  virtual void SetWifiPhy (Ptr<FullWifiPhy> phy) = 0;
  /**
   * \param stationManager the station manager attached to this MAC.
   */
  virtual void SetWifiRemoteStationManager (Ptr<FullWifiRemoteStationManager> stationManager) = 0;
  /**
   ...
   */
  void ConfigureStandard (enum FullWifiPhyStandard standard);

protected:
  void ConfigureDcf (Ptr<FullDcf> dcf, uint32_t cwmin, uint32_t cwmax, enum AcIndex ac);
  void ConfigureCCHDcf (Ptr<FullDcf> dcf, uint32_t cwmin, uint32_t cwmax, enum AcIndex ac);
private:
   ...
   * requested standard.
   */
  virtual void FinishConfigureStandard (enum FullWifiPhyStandard standard) = 0;
