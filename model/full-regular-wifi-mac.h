 ...
 */
#ifndef FULL_REGULAR_WIFI_MAC_H
#define FULL_REGULAR_WIFI_MAC_H
 ...
 *
 */
class FullRegularWifiMac : public FullWifiMac
{
public:
  static TypeId GetTypeId (void);

  FullRegularWifiMac ();
  virtual ~FullRegularWifiMac ();
   ...
   */
  virtual FullSsid GetSsid (void) const;
  /**
   ...
   */
  virtual void SetSsid (FullSsid ssid);
  /**
   ...
   */
  virtual void SetWifiPhy (Ptr<FullWifiPhy> phy);
  /**
   * \returns the physical layer attached to this MAC.
   */
  virtual Ptr<FullWifiPhy> GetWifiPhy () const;
  /**
   ...
   */
  virtual Ptr<FullWifiRemoteStationManager> GetWifiRemoteStationManager () const;
  ...
  void SetForwardQueue (Ptr<ForwardQueue> forwardingQueue);

protected:
  virtual void DoInitialize ();
  virtual void DoDispose ();

  FullMacRxMiddle *m_rxMiddle;
   ...
   */
  virtual void FinishConfigureStandard (enum FullWifiPhyStandard standard);
  ...
  virtual void AckTimeout (const FullWifiMacHeader &hdr);
  virtual void SendPacket (const FullWifiMacHeader &hdr);
   ...
   */
  virtual void SendAddBaResponse (const FullMgtAddBaRequestHeader *reqHdr,
...
private:
  FullRegularWifiMac (const FullRegularWifiMac &);
  FullRegularWifiMac & operator= (const FullRegularWifiMac &);
  ...
  Ptr<FullDcaTxop> GetDcaTxop (void) const;

  /** Accessor for the AC_VO channel access function */
  Ptr<FullEdcaTxopN> GetVOQueue (void) const;
  /** Accessor for the AC_VI channel access function */
  Ptr<FullEdcaTxopN> GetVIQueue (void) const;
  /** Accessor for the AC_BE channel access function */
  Ptr<FullEdcaTxopN> GetBEQueue (void) const;
  /** Accessor for the AC_BK channel access function */
  Ptr<FullEdcaTxopN> GetBKQueue (void) const;

  TracedCallback<const FullWifiMacHeader &> m_txOkCallback;
  TracedCallback<const FullWifiMacHeader &> m_txErrCallback;
  TracedCallback<const FullWifiMacHeader &> m_ackTimeoutCallback;
  TracedCallback<const FullWifiMacHeader &> m_sendPacketCallback;
...
//  ForwardQueue m_forwardQueue;

};

} // namespace ns3

#endif /* FULL_REGULAR_WIFI_MAC_H */
