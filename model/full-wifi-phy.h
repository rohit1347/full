...
#ifndef FULL_WIFI_PHY_H
#define FULL_WIFI_PHY_H
 ...
 */
class FullWifiPhyListener
{
public:
  virtual ~FullWifiPhyListener ();
   ...
   *   - NotifyTxStart
   */
  virtual void NotifyRxStart (Time duration, Ptr<const Packet> packet, FullWifiMode txMode, FullWifiPreamble preamble) = 0;
  /**
 ...
 *
 */
class FullWifiPhy : public Object
{
public:
  /**
   ...
   */
  typedef Callback<void,Ptr<Packet>, double, FullWifiMode, enum FullWifiPreamble> RxOkCallback;
  /**
   ...
   */
  virtual void SendPacket (Ptr<const Packet> packet, FullWifiMode mode, enum FullWifiPreamble preamble, uint8_t txPowerLevel) = 0;
   ...
   * PHY-level events.
   */
  virtual void RegisterListener (FullWifiPhyListener *listener) = 0;

  /**
   * \returns true of the current state of the PHY layer is WifiPhy::IDLE, false otherwise.
   */
  virtual bool IsRxStateIdle (void) = 0;
  virtual bool IsTxStateIdle (void) = 0;
   ...
   */
  virtual bool IsRxStateBusy (void) = 0;
  virtual bool IsTxStateBusy (void) = 0;
   ...
   */
  virtual Time GetRxStateDuration (void) = 0;
  virtual Time GetTxStateDuration (void) = 0;
   ...
   */
  virtual Time GetTxDelayUntilIdle (void) = 0;
  virtual Time GetRxDelayUntilIdle (void) = 0;
   ...
   */
  static Time CalculateTxDuration (uint32_t size, FullWifiMode payloadMode, enum FullWifiPreamble preamble);

  /** 
   * \param payloadMode the FullWifiMode use for the transmission of the payload
   * \param preamble the type of preamble
   * 
   * \return the FullWifiMode used for the transmission of the PLCP header
   */
  static FullWifiMode GetPlcpHeaderMode (FullWifiMode payloadMode, FullWifiPreamble preamble);
   ...
   */
  static uint32_t GetPlcpHeaderDurationMicroSeconds (FullWifiMode payloadMode, FullWifiPreamble preamble);
   ...
   */
  static uint32_t GetPlcpPreambleDurationMicroSeconds (FullWifiMode payloadMode, FullWifiPreamble preamble);
   ...
   */
  static uint32_t GetPayloadDurationMicroSeconds (uint32_t size, FullWifiMode payloadMode);

  /**
   * The WifiPhy::GetNModes() and WifiPhy::GetMode() methods are used
   * (e.g., by a WifiRemoteStationManager) to determine the set of
   * transmission/reception modes that this WifiPhy(-derived class)
   * can support - a set of FullWifiMode objects which we call the
   ...
   */
  virtual FullWifiMode GetMode (uint32_t mode) const = 0;
  /**
   ...
   */
  virtual double CalculateSnr (FullWifiMode txMode, double ber) const = 0;
  ...
  virtual void ConfigureStandard (enum FullWifiPhyStandard standard) = 0;

  virtual Ptr<FullWifiChannel> GetChannel (void) const = 0;

  static FullWifiMode GetDsssRate1Mbps ();
  static FullWifiMode GetDsssRate2Mbps ();
  static FullWifiMode GetDsssRate5_5Mbps ();
  static FullWifiMode GetDsssRate11Mbps ();
  static FullWifiMode GetErpOfdmRate6Mbps ();
  static FullWifiMode GetErpOfdmRate9Mbps ();
  static FullWifiMode GetErpOfdmRate12Mbps ();
  static FullWifiMode GetErpOfdmRate18Mbps ();
  static FullWifiMode GetErpOfdmRate24Mbps ();
  static FullWifiMode GetErpOfdmRate36Mbps ();
  static FullWifiMode GetErpOfdmRate48Mbps ();
  static FullWifiMode GetErpOfdmRate54Mbps ();
  static FullWifiMode GetOfdmRate6Mbps ();
  static FullWifiMode GetOfdmRate9Mbps ();
  static FullWifiMode GetOfdmRate12Mbps ();
  static FullWifiMode GetOfdmRate18Mbps ();
  static FullWifiMode GetOfdmRate24Mbps ();
  static FullWifiMode GetOfdmRate36Mbps ();
  static FullWifiMode GetOfdmRate48Mbps ();
  static FullWifiMode GetOfdmRate54Mbps ();
  static FullWifiMode GetOfdmRate3MbpsBW10MHz ();
  static FullWifiMode GetOfdmRate4_5MbpsBW10MHz ();
  static FullWifiMode GetOfdmRate6MbpsBW10MHz ();
  static FullWifiMode GetOfdmRate9MbpsBW10MHz ();
  static FullWifiMode GetOfdmRate12MbpsBW10MHz ();
  static FullWifiMode GetOfdmRate18MbpsBW10MHz ();
  static FullWifiMode GetOfdmRate24MbpsBW10MHz ();
  static FullWifiMode GetOfdmRate27MbpsBW10MHz ();
  static FullWifiMode GetOfdmRate1_5MbpsBW5MHz ();
  static FullWifiMode GetOfdmRate2_25MbpsBW5MHz ();
  static FullWifiMode GetOfdmRate3MbpsBW5MHz ();
  static FullWifiMode GetOfdmRate4_5MbpsBW5MHz ();
  static FullWifiMode GetOfdmRate6MbpsBW5MHz ();
  static FullWifiMode GetOfdmRate9MbpsBW5MHz ();
  static FullWifiMode GetOfdmRate12MbpsBW5MHz ();
  static FullWifiMode GetOfdmRate13_5MbpsBW5MHz ();
