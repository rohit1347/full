...
FullWifiInformationElement::~FullWifiInformationElement ()
{
}

void
FullWifiInformationElement::Print (std::ostream &os) const
{
}

uint16_t
FullWifiInformationElement::GetSerializedSize () const
{
  return (2 + GetInformationFieldSize ());
}

Buffer::Iterator
FullWifiInformationElement::Serialize (Buffer::Iterator i) const
{
  i.WriteU8 (ElementId ());
...
Buffer::Iterator
FullWifiInformationElement::Deserialize (Buffer::Iterator i)
{
...
Buffer::Iterator
FullWifiInformationElement::DeserializeIfPresent (Buffer::Iterator i)
{
  Buffer::Iterator start = i;
...
bool
FullWifiInformationElement::operator< (FullWifiInformationElement const & a) const
{
