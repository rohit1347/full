 ...
 */
#ifndef FULL_SUPPORTED_RATES_H
#define FULL_SUPPORTED_RATES_H
 ...
 * SupportedRates.
 */
class FullExtendedSupportedRatesIE : public FullWifiInformationElement
{
public:
  FullExtendedSupportedRatesIE ();
  FullExtendedSupportedRatesIE (FullSupportedRates *rates);
...
private:
   ...
   */
  FullSupportedRates *m_supportedRates;
};
 ...
 */
class FullSupportedRates : public FullWifiInformationElement
{
public:
  FullSupportedRates ();
   ...
   * extended.
   */
  friend class FullExtendedSupportedRatesIE;
  FullExtendedSupportedRatesIE extended;
private:
  uint8_t m_nRates;
