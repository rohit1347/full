 ...
 */
#ifndef FULL_MSDU_STANDARD_AGGREGATOR_H
#define FULL_MSDU_STANDARD_AGGREGATOR_H
 ...
 *
 */
class FullMsduStandardAggregator : public FullMsduAggregator
{
public:
  static TypeId GetTypeId (void);
  FullMsduStandardAggregator ();
  ~FullMsduStandardAggregator ();
  /**
...
#endif /* FULL_MSDU_STANDARD_AGGREGATOR_H */
