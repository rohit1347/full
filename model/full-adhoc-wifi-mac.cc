...
NS_LOG_COMPONENT_DEFINE ("FullAdhocWifiMac");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (FullAdhocWifiMac);

TypeId
FullAdhocWifiMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::FullAdhocWifiMac")
    .SetParent<FullRegularWifiMac> ()
    .AddConstructor<FullAdhocWifiMac> ()
  ;
  return tid;
}

FullAdhocWifiMac::FullAdhocWifiMac ()
{
...
void
FullAdhocWifiMac::SetAddress (Mac48Address address)
{
...
void
FullAdhocWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
void
FullAdhocWifiMac::SetLinkUpCallback (Callback<void> linkUp)
{
  NS_LOG_FUNCTION (this);
...
void
FullAdhocWifiMac::Receive (Ptr<Packet> packet, const FullWifiMacHeader *hdr)
{
