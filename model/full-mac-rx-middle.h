...
#ifndef FULL_MAC_RX_MIDDLE_H
#define FULL_MAC_RX_MIDDLE_H
...
{
public:
  typedef Callback<void, Ptr<Packet>, const FullWifiMacHeader*> ForwardUpCallback;
  ...
  void Receive (Ptr<Packet> packet, const FullWifiMacHeader *hdr);
private:
  friend class MacRxMiddleTest;
  OriginatorRxStatus* Lookup (const FullWifiMacHeader* hdr);
  bool IsDuplicate (const FullWifiMacHeader* hdr, OriginatorRxStatus *originator) const;
  Ptr<Packet> HandleFragments (Ptr<Packet> packet, const FullWifiMacHeader* hdr,
