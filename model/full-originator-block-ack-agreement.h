 ...
 */
#ifndef FULL_ORIGINATOR_BLOCK_ACK_AGREEMENT_H
#define FULL_ORIGINATOR_BLOCK_ACK_AGREEMENT_H
 ...
 */
class FullOriginatorBlockAckAgreement : public FullBlockAckAgreement
{
  friend class FullBlockAckManager;
public:
  FullOriginatorBlockAckAgreement ();
  FullOriginatorBlockAckAgreement (Mac48Address recipient, uint8_t tid);
  ~FullOriginatorBlockAckAgreement ();
...
#endif /* FULL_ORIGINATOR_BLOCK_ACK_AGREEMENT_H */
