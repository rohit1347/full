 ...
 */
#ifndef FULL_ARF_WIFI_MANAGER_H
#define FULL_ARF_WIFI_MANAGER_H
 ...
 * timer.)
 */
class FullArfWifiManager : public FullWifiRemoteStationManager
{
public:
  static TypeId GetTypeId (void);
  FullArfWifiManager ();
  virtual ~FullArfWifiManager ();
