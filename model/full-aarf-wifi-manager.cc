...
#include "full-aarf-wifi-manager.h"
...
NS_LOG_COMPONENT_DEFINE ("FullAarfWifiManager");

namespace ns3 {

struct AarfWifiRemoteStation : public FullWifiRemoteStation
{
  uint32_t m_timer;
  uint32_t m_success;
  uint32_t m_failed;
...
FullAarfWifiManager::DoCreateStation (void) const
{
...
void
FullAarfWifiManager::DoReportRtsFailed (FullWifiRemoteStation *station)
{
}
/**
 ...
 */
void
FullAarfWifiManager::DoReportDataFailed (FullWifiRemoteStation *st)
{
...
void
FullAarfWifiManager::DoReportRxOk (FullWifiRemoteStation *station,
                               double rxSnr, FullWifiMode txMode)
{
}
void
FullAarfWifiManager::DoReportRtsOk (FullWifiRemoteStation *station,
                                double ctsSnr, FullWifiMode ctsMode, double rtsSnr)
{
  NS_LOG_DEBUG ("station=" << station << " rts ok");
}
void
FullAarfWifiManager::DoReportDataOk (FullWifiRemoteStation *st,
...
void
FullAarfWifiManager::DoReportFinalRtsFailed (FullWifiRemoteStation *station)
{
}
void
FullAarfWifiManager::DoReportFinalDataFailed (FullWifiRemoteStation *station)
{
}

FullWifiMode
FullAarfWifiManager::DoGetDataMode (FullWifiRemoteStation *st, uint32_t size)
{
  AarfWifiRemoteStation *station = (AarfWifiRemoteStation *) st;
  return GetSupported (station, station->m_rate);
}
FullWifiMode
FullAarfWifiManager::DoGetRtsMode (FullWifiRemoteStation *st)
{
...
bool
FullAarfWifiManager::IsLowLatency (void) const
{
  return true;
}
