 ...
 */
#ifndef FULL_MSDU_AGGREGATOR_H
#define FULL_MSDU_AGGREGATOR_H
 ...
 * \ingroup wifi
 */
class FullMsduAggregator : public Object
{
public:
  typedef std::list<std::pair<Ptr<Packet>, FullAmsduSubframeHeader> > DeaggregatedMsdus;
  typedef std::list<std::pair<Ptr<Packet>, FullAmsduSubframeHeader> >::const_iterator DeaggregatedMsdusCI;
