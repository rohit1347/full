...
NS_LOG_COMPONENT_DEFINE ("FullMacRxMiddle");
...
FullMacRxMiddle::FullMacRxMiddle ()
{
...
void
FullMacRxMiddle::SetForwardCallback (ForwardUpCallback callback)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_callback = callback;
}
...
OriginatorRxStatus *
FullMacRxMiddle::Lookup (const FullWifiMacHeader *hdr)
{
  NS_LOG_FUNCTION (hdr);
...
bool
FullMacRxMiddle::IsDuplicate (const FullWifiMacHeader* hdr,
...
Ptr<Packet>
FullMacRxMiddle::HandleFragments (Ptr<Packet> packet, const FullWifiMacHeader *hdr,
                              OriginatorRxStatus *originator)
{
...
void
FullMacRxMiddle::Receive (Ptr<Packet> packet, const FullWifiMacHeader *hdr)
{
