...
#ifndef FULL_DSS_ERROR_RATE_MODEL_H
#define FULL_DSS_ERROR_RATE_MODEL_H
#include <stdint.h>
...
#else
protected:
  static const double FULL_WLAN_SIR_PERFECT;
  static const double FULL_WLAN_SIR_IMPOSSIBLE;
#endif
};

} // namespace ns3

#endif /* FULL_DSSS_ERROR_RATE_MODEL_H */
