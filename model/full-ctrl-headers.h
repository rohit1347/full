 ...
 */
#ifndef FULL_CTRL_HEADERS_H
#define FULL_CTRL_HEADERS_H
...
#ifndef BLOCK_ACK_TYPE
#define BLOCK_ACK_TYPE
enum BlockAckType
{
  BASIC_BLOCK_ACK,
 ...
 */
class FullCtrlBAckRequestHeader : public Header
{
public:
  FullCtrlBAckRequestHeader ();
  ~FullCtrlBAckRequestHeader ();
 ...
 *  Basic block ack is also default variant.
 */
class FullCtrlBAckResponseHeader : public Header
{
public:
  FullCtrlBAckResponseHeader ();
  ~FullCtrlBAckResponseHeader ();
  static TypeId GetTypeId (void);
  virtual TypeId GetInstanceTypeId (void) const;
  virtual void Print (std::ostream &os) const;
